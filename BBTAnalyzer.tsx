...
const BBTAnalyzer = () => {
  ...
  const [selectedBBT, setSelectedBBT] = useState(null);
  ...
  return (
    <div className="container">
            ...
            <tbody>
              {rows.map((row, index) => (
                <tr key={row.id}>
                  ...
                  <td>
                    <button onClick={() => handleViewBBT(row)}>View</button>
                  </td>
                  <td>
      ...
      {selectedBBT && <BBTDetailView data={selectedBBT} onClose={handleCloseDetail} />}
